...
import { View, StyleSheet, Text, ScrollView, Image, TouchableOpacity, Platform, StatusBar, ImageBackground } from "react-native";
...
const Bidding = () => {
  ...
  const decreaseBid = () => {
    if (bidAmount > 0) { // Assuming the bid can't go below 0
      setBidAmount(bidAmount - 5);
    }
  };
  return (
    <ImageBackground source={require("../assets/Dashboard/dashbg.jpeg")} style={tw.style("h-full")}>
      <ScrollView>
        <View
          style={tw.style({
        ...
        >
          ...
          <View style={styles.userInfoContainer}>
            <Image source={{ uri: selectedTripData.user.profilePic }} style={styles.dp} />
          ...
          <View style={styles.section}>
            ...
            <View style={tw.style({ marginRight: "10%" })}>
              ...
              <Text style={tw.style("text-white")}>Rs. {selectedTripData.trip.buyout}</Text>
              <Text style={tw.style("text-white")}>Rs. {selectedTripData.trip.startbid}</Text>
            </View>
          </View>
          <View>
            <Image source={require("../assets/CurrentTrips/line.png")} />
          ...
          <View style={tw.style({ marginBottom: "10%" })}>
            ...
            <Text style={tw.style("text-white")}>{selectedTripData.trip.description}</Text>
          </View>
        </View>
        </View>
        <View style={tw.style({ marginLeft: "50%" })}>
        <View style={tw`flex-row items-center justify-center my-2`}>
          <TouchableOpacity onPress={decreaseBid} style={tw`bg-blue-200 p-2 rounded-full mx-2`}>
            <Text style={tw`text-blue-900 text-xl font-semibold`}>-</Text>
          </TouchableOpacity>

          <View style={tw`mx-1 p-2 bg-white rounded-lg`}>
            <Text style={tw`text-center text-lg font-semibold`}>{bidAmount}</Text>
          </View>

          <TouchableOpacity onPress={increaseBid} style={tw`bg-blue-200 p-2 rounded-full mx-2`}>
            <Text style={tw`text-blue-900 text-xl font-semibold`}>+</Text>
          </TouchableOpacity>
        </View>

        <TouchableOpacity style={tw`bg-cyan-600 px-7 py-2 rounded-full self-center mb-4`}>
          <Text style={tw`text-white text-lg font-bold text-center`}>Place Bid</Text>
        </TouchableOpacity>
        </View>
      </ScrollView>
